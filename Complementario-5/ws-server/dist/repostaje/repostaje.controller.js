...
let RepostajeController = class RepostajeController {
    ...
    async update(REPOSTAJE_ID, UpdateRepostajeDto) {
        try {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_repostaje_dto_1.CreateRepostajeDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_repostaje_dto_1.UpdateRepostajeDto]),
    __metadata("design:returntype", Promise)
